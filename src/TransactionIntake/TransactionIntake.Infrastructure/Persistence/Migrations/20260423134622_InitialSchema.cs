...
public partial class InitialSchema : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex(name: "uq_idempotency_keys_key_hash",       table: "idempotency_keys", column: "key_hash",        unique: true);
        migrationBuilder.CreateIndex(name: "ix_transactions_correlation_id",     table: "transactions",    column: "correlation_id");
        migrationBuilder.CreateIndex(name: "uq_transactions_idempotency_key_hash", table: "transactions",  column: "idempotency_key_hash", unique: true);
