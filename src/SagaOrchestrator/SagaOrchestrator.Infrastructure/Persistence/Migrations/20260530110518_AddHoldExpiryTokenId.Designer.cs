...
namespace PlatformWallet.SagaOrchestrator.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260530110518_AddHoldExpiryTokenId")]
    partial class AddHoldExpiryTokenId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PlatformWallet.SagaOrchestrator.Domain.TransactionSagaState", b =>
                {
                    ...
                    b.Property<Guid?>("HoldExpiryTokenId")
                        .HasColumnType("uuid")
                        .HasColumnName("hold_expiry_token_id");
